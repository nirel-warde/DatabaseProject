...
public class EmployeeGateway {
    ...
    private static final String INSERT_EMPLOYEES = "INSERT INTO employees.employees_table (employeeID,namePrefix,firstName,middleInitial,lastName,gender,email,dob,dateOfJoining,salary) VALUES (?,?,?,?,?,?,?,?,?,?)";
